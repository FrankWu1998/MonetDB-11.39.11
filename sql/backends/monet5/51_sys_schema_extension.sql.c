unsigned char _51_sys_schema_extension_sql[8667] = {
...
#endif
LIB_STARTUP_FUNC(init_51_sys_schema_extension_sql)
{ sql_register("51_sys_schema_extension", _51_sys_schema_extension_sql); }
